          ...
          <dl class="mt-10 space-y-4 text-base leading-7 text-gray-800">
            <div class="flex gap-x-4">
              <dt class="flex-none">
                ...
                <Icon name="mdi-light:pin" size="30" class="text-indigo-600" />
              </dt>
              <dd>
                <a
                  :href="address.url"
            ...
            <div class="flex gap-x-4">
              ...
              <dd>
                <a class="hover:text-gray-900" :href="`tel:${phone.url}`">{{
                  phone.label
                }}</a>
              </dd>
            </div>
            <div class="flex gap-x-4">
              <dt class="flex-none">
                ...
                <Icon
                  name="ph:envelope-open-thin"
                  size="30"
                  class="text-indigo-600"
                />
              </dt>
              <dd>
                <a class="hover:text-gray-900" :href="`mailto:${email.url}`">{{
                  email.label
                }}</a>
              </dd>
            </div>
          ...
          <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
            <div>
              ...
              <div class="mt-2.5">
                ...
                />
                <!-- Dummy validation styles -->
                <div class="mt-1 text-red-500 text-sm" v-show="inputError">
