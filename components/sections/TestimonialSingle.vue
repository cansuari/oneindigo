<template>
  <section
    class="relative isolate overflow-hidden bg-white px-6 my-24 md:my-36 lg:px-8"
  >
    <div
    ...
    <div class="mx-auto max-w-2xl lg:max-w-4xl">
      <img
        ...
        alt=""
      />
      <figure class="mt-10 relative">
        <svg
          viewBox="0 0 162 128"
          fill="none"
          aria-hidden="true"
          class="absolute -top-12 left-0 -z-10 h-32 stroke-gray-200/80"
        >
          <path
